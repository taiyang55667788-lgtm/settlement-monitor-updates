...
const { alertLedgerKey, alertHistoryForPeriod, pendingAlertNotifications, recordAlertLevel } = require('../electron/alert-ledger');
...
test('a new report week resets sent tiers while the same week preserves them', () => {
  const prior = { period: '2026-09-14/2026-09-20', agents: { known: { positiveMax: 3, negativeMax: 1 } } };
  ...
  assert.deepEqual(alertHistoryForPeriod(prior, '2026-09-21/2026-09-27'), {
    period: '2026-09-21/2026-09-27', agents: {},
  });
});
